...
**
![enter image description here](http://3.bp.blogspot.com/-Yp2mLTok2dg/VdHgp94rxNI/AAAAAAAANBo/oU1O9ZGSvns/s1600/Cabra.jpg)
--------------------------------------------------------
...
> 6. Escribe en el campo de título: Ejercicio nombre y apellido; y en descripción: Incluí el documento "tunombreapellido-ejercicio.md" en
> este cambio.
...
El objetivo con el libro era responderse la pregunta de qué representa hoy ese país para los latinos.Por:  MARÍA PAULINA ORTIZ. 2 de junio de 2012. [Enlace al origina](http://www.eltiempo.com/archivo/documento/CMS-11917603)l:
...
> 'Sam no es mi tío' pretende narrar un país: Estados Unidos. Y sí: eso
> resulta difícil.

<iframe id="datawrapper-chart-sQWj7" src="//datawrapper.dwcdn.net/sQWj7/1/" frameborder="0" allowtransparency="true" allowfullscreen="allowfullscreen" webkitallowfullscreen="webkitallowfullscreen" mozallowfullscreen="mozallowfullscreen" oallowfullscreen="oallowfullscreen" msallowfullscreen="msallowfullscreen" width="100%" height="378"></iframe><script type="text/javascript">"undefined"==typeof window.datawrapper&&(window.datawrapper={}),window.datawrapper["sQWj7"]={},window.datawrapper["sQWj7"].embedDeltas={"100":514,"200":432,"300":405,"400":405,"500":378,"600":378,"700":378,"800":378,"900":378,"1000":378},window.datawrapper["sQWj7"].iframe=document.getElementById("datawrapper-chart-sQWj7"),window.datawrapper["sQWj7"].iframe.style.height=window.datawrapper["sQWj7"].embedDeltas[Math.min(1e3,Math.max(100*Math.floor(window.datawrapper["sQWj7"].iframe.offsetWidth/100),100))]+"px",window.addEventListener("message",function(a){if("undefined"!=typeof a.data["datawrapper-height"])for(var b in a.data["datawrapper-height"])"sQWj7"==b&&(window.datawrapper["sQWj7"].iframe.style.height=a.data["datawrapper-height"][b]+"px")});</script>
